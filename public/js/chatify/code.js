  ...
  if (messenger != 0) {
    ...
    $.ajax({
      ...
      success: (data) => {
        ...
        $(".messenger-infoView")
          .find(".avatar")
          .css("background-image", 'url("' + data.user_avatar + '")');//CHANGE AVATAR SA SIDE CONT MESSAGE WITH SPECIFIC USER
        $(".header-avatar").css(
          "background-image",
          'url("' + data.user_avatar + '")' //CHANGE AVATAR SA HEADER MESSAGE WITH SPECIFIC USER
        );
