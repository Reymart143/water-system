        ...
        <div class="container-fluid">
                    ...
                    <div class="col-md-12 mt-4">
                        <div class="white_shd full margin_bottom_30" style="position: relative; z-index: 2;">
                            <div class="full graph_head" style="background: #007bff; border-radius: 5px;">
                                <h2 class="mt-1" style="color: white !important;">Account Receivables</h2>
                            </div>
                        </div>
                    </div>
                </div>    
                ...
                <div class="col-md-12">
                    <div class="white_shd full margin_bottom_30" style="position: relative; z-index: 1;margin-top: -55px;">
                        ...
                        <div class="card-body mt-4" style="padding: 20px;" style="width: 100% !important;">
                            ...
                            <table id="account_receivable" class="display table table-bordered" style="color:black !important;width: 100% !important;">
                                <thead>
                                    <tr>
                                        <th>Account ID</th>
                                        <th>Name</th>
           ...
           <script>
                $(document).ready(function(){
                    ...
                    var StatementdataTable = $('#account_receivable').DataTable({
                        ...
                        serverSide:true,
                        ajax: "/treasurer-account-receivables",
                        columns: [
                        {
                            data : 'account_id',
                            name : 'account_id'
